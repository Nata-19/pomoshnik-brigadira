...
const defaultsTests = [
  ...
  ['Selectors + текст содержит свой квартал — текст побеждает',
   'Иванов с 1 по 3\nКвартал 2 клетка 1 петров с 5 по 7',
   { quarter: '1', cell: '1' }],
  ['Диапазон + одиночные ряды через "и" (баг с потерей)',
   'Света с 24 по 29 и 40\nЛена с 30 по 34 и 41',
   { quarter: '9', cell: '10' }],
  ['Диапазон + ряды через запятую',
   'Света с 24 по 29, 40, 41',
   { quarter: '9', cell: '10' }],
  ['Два диапазона через "и"',
   'Иванов с 24 по 29 и с 35 по 38',
   { quarter: '9', cell: '10' }],
];
